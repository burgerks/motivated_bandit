...
Run
---
    python3 analyze_bandit_mid_v4.py
"""
...
# Task design constants. These mirror the CFG block in bandit_mid_task_v16.py and
...
def build_qc_flags(s: Dict[str, float]) -> Tuple[List[str], bool, str]:
    ...
    if s.get("max_swap_count", 0) < REVERSALS_PER_RUN:
    ...
    if "did_not_learn" in flags:
        reasons.append("overall choice not above chance")
